...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '活动信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '活动审批记录表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '活动报名表' ROW_FORMAT = Dynamic;
...
INSERT INTO `club_applications` VALUES (2, '2022002', 2, '王二', '信息安全', '2022级', '13800138010', 'wanger@example.com', '热爱音乐，会弹吉他，希望能和更多志同道合的朋友一起交流', '高中时期是学校乐队成员，有一定的音乐基础', '音乐演出、乐器交流', '周二、四晚上', NULL, '待审核', NULL, NULL, '2023-10-12 09:15:00');
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '社团成员关系表' ROW_FORMAT = Dynamic;
...
INSERT INTO `clubs` VALUES (2, 2, '音乐社', '热爱音乐的学生聚集地，定期举办音乐会', 'https://example.com/logo/music_club.jpg', '2021002', '2019-09-01', 30, 60, 'music_club@example.com', '每周五晚上18:30-20:30', '艺术楼B201', 1, '2025-11-24 10:52:51', '2025-11-24 10:52:51', 1);
